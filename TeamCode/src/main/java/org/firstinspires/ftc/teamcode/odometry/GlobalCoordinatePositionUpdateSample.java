...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalLeftEncoderName = "leftFrontDrive", verticalRightEncoderName = "rightFrontDrive", horizontalEncoderName = "leftBackDrive";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        OdometryGlobalPosition globalPositionUpdate = new OdometryGlobalPosition(verticalLeft, verticalRight, horizontal, COUNTS_PER_INCH, 75);
